...
# Following are the criteria for checking the password:
    ...
    # to the above criteria. Passwords that match the criteria 
...
def login():
    # ([a-zA-Z0-9]+)([$#@!%^&*()\[\];':"./>?<\,]+)
    # st = "ABd1234@1,a F1#,2w3E*,2We3345,ABc123!@,123abcD@,azAdaB9$,$saAbfdkal1"
    
    passwords = [password for password in input("Enter Password: ").split(",")]
    accepted_passwords = []
